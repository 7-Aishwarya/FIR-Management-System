...
label_img.image = img
label_img.pack()
label_img.place(relx=0.5, y=90, anchor=N)

# Inserting image to the left
left_image = PhotoImage(file="D:\FIR Management System\signuplogo.png")
left_label = Label(root, image=left_image, background='#264348')
...
right_label = Label(root, image=right_image, background='#264348')
right_label.pack(side=RIGHT, padx=10, pady=10)

b = Button(root, text='Login', width=13, height=1, bg='#afa394', fg='black', background="#89C4F4", font=("Century Gothic", 16, "bold"), command=printtext)
b.place(relx=0.5, rely=0.7, anchor=CENTER)

b =Button(root, text='Quit', width=13, height=1, bg='#afa394', fg='black', background="#FF0000", font=("Century Gothic", 16, "bold"), command=dest)
b.place(relx=0.5, rely=0.75, anchor=CENTER)

b =Button(root, text='Sign-up', width=13, height=1, bg='#afa394', background="#89C4F4", font=("Century Gothic", 16, "bold"), fg='black', command=sin)
