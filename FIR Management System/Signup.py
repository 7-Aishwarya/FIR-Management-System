...
image = Image.open("D:\FIR-Management-System-File-Structures-main\FIR Management System\signuplogo.png")
...
right_label = Label(root, image=right_image, background='black')
right_label.pack(side=RIGHT, padx=10, pady=10)

b = Button(root, text='Submit', width=13, height=1, bg='#049372', fg='black', command=printtext,
           font=("Century Gothic", 16, "bold"), activebackground="#00ff00")
b.place(relx=0.5, y=650, anchor=CENTER)

Button(root, text='Login', width=13, height=1, bg='#049372', fg='black', command=log,
       font=("Century Gothic", 16, "bold"), activebackground="#00ff00").place(relx=0.5, y=700, anchor=CENTER)

Button(root, text='Quit', width=13, height=1, bg='#D24D57', fg='black', command=dest,
       font=("Century Gothic", 16, "bold"), activebackground="#ff0000").place(relx=0.5, y=750, anchor=CENTER)
